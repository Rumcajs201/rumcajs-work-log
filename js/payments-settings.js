...
const TEXT = {
  pl: {
    saved:"Ustawienia płatności zapisane", method:"Sposób wynagrodzenia", gross:"Wszystkie kwoty wpisuj jako brutto.",
...
async function savePayments(event){
  ...
  const data={
    ...current,id:"main",paymentMethod:$("#paymentMethod")?.value||"hourly",
